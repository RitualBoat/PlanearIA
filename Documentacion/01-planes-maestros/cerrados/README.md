# Planes Maestros Cerrados

Esta carpeta agrupa los planes maestros que ya quedaron cerrados. Se conservan como referencia de calidad, decisiones y tracking. No deben reabrirse salvo bug nuevo o decision explicita del desarrollador.
...
| Infraestructura Local, CI y Deploy Basico | `PLAN_INFRAESTRUCTURA_LOCAL_CI_DEPLOY (closed).md` | Fases 0 a 7 completadas. |
| Storage Local SQLite y Migracion Offline | `PLAN_STORAGE_LOCAL_SQLITE_MIGRACION_OFFLINE (closed).md` | Cerrado para entrega academica; SQLite opt-in con rollback. |
