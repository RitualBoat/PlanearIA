# Plan Maestro: RefactorizaciÃƒÂ³n del MÃƒÂ³dulo de Planeaciones Ã¢â‚¬â€ PlanearIA

> **VersiÃƒÂ³n:** 1.0  
> **Fecha:** 2026-05-27  
> **Alcance:** RediseÃƒÂ±o completo del mÃƒÂ³dulo de Planeaciones (tipos, datos, UI, IA, backend, sync)  
> **Stack:** React Native 0.81.5 Ã‚Â· Expo 54 Ã‚Â· TypeScript 5.9 Ã‚Â· MongoDB Atlas Ã‚Â· AsyncStorage Ã‚Â· MVVM
...
## AnÃƒÂ¡lisis del Ground Truth Ã¢â‚¬â€ Planeaciones Reales

> [!IMPORTANT]
> Todas las decisiones de este plan se fundamentan en el anÃƒÂ¡lisis de planeaciones reales creadas por docentes mexicanos. Archivos analizados:
>
> - [primero.md](file:///c:/Users/jarco/dev/PlanearIA/context/planeaciones-reales/semana%2033%20y%2034%20primero/primero.md) Ã¢â‚¬â€ 1er grado, EspaÃƒÂ±ol, 10 sesiones
> - [segundo.md](file:///c:/Users/jarco/dev/PlanearIA/context/planeaciones-reales/semana%2033%20y%2034%20segundo/segundo.md) Ã¢â‚¬â€ 2do grado, EspaÃƒÂ±ol, 10 sesiones
> - [Matediscretas.md](file:///c:/Users/jarco/dev/PlanearIA/context/planeaciones-reales/MATEDISCRETA/Matediscretas.md) Ã¢â‚¬â€ MatemÃƒÂ¡ticas Discretas I, nivel universidad (transcrito)
...
| ---------------------- | ------------------------------------------------------ | --------------------------------------------------------------------------- |
| Sesiones               | 1 sesiÃƒÂ³n con 3 actividades (inicio/desarrollo/cierre) | **10 sesiones** multi-semana, cada una con inicio/desarrollo/cierre/tarea   |
| EvaluaciÃƒÂ³n            | Campo string simple                                    | Instrumentos dinÃƒÂ¡micos (escalas de 3 o 4 puntos, rÃƒÂºbricas con criterios)  |
| Metadata institucional | No existe                                              | InstituciÃƒÂ³n, subsistema, ciclo escolar, lugar                              |
| Curriculum NEM         | Parcial                                                | PropÃƒÂ³sito, PDA, campo formativo, eje articulador, rasgos perfil egreso     |
| Firmas                 | No existe                                              | Coordinadora acadÃƒÂ©mica + docente                                           |
| Observaciones          | String simple                                          | Array de notas estructuradas (flexibilidad, USAER, proyectos)               |
| Actividades embebidas  | No existen                                             | Verdadero/falso (Ã¢ËœÂ), preguntas guÃƒÂ­a numeradas, matching, escritura guiada |
| Cobertura temporal     | 1 fecha                                                | Rango de fechas multi-semana                                                |

---

## Inventario de CÃƒÂ³digo Actual del MÃƒÂ³dulo
...
graph TD
    subgraph Tipos
        T1["types/planeacion.ts (192 lÃƒÂ­neas)"]
        T2["types/index.ts Ã¢â‚¬â€ PlaneacionFormData (LEGACY)"]
    end
    subgraph Pantallas
    ...
    subgraph Servicios
        SV1["services/planeacionImportService.ts (330 lÃƒÂ­neas)"]
        SV2["services/planeacionExportService.ts (262 lÃƒÂ­neas)"]
    end
    subgraph Sync
        SY1["sync/providers/SyncProvider.tsx (291 lÃƒÂ­neas)"]
    ...
    subgraph NavegaciÃƒÂ³n
        N1["navigation/StackNavigator.tsx Ã¢â‚¬â€ 7 rutas planeaciÃƒÂ³n"]
    end
end
```
...
## Decisiones TÃƒÂ©cnicas

### 1. Editor Tipo "Docs/Word"

> [!IMPORTANT]
> **DecisiÃƒÂ³n: Editor de bloques estructurado con WebView embebida para el canvas de texto enriquecido.**
...
| OpciÃƒÂ³n                                  | Veredicto       | RazÃƒÂ³n                                                                                                  |
| ---------------------------------------- | --------------- | ------------------------------------------------------------------------------------------------------- |
| `TextInput` multiline                    | Ã¢ÂÅ’ Descartado   | Sin formato, sin tablas, sin listas                                                                     |
| `react-native-pell-rich-editor`          | Ã¢ÂÅ’ Descartado   | Abandonado, bugs crÃƒÂ­ticos en Expo                                                                      |
| `@10play/tentap-editor` (Tiptap para RN) | Ã¢Å“â€¦ **ELEGIDO** | Tiptap/ProseMirror en WebView. Modular, extensible, soporte offline. Toolbar nativa RN + canvas WebView |
| Custom WebView + Quill/Tiptap            | Ã¢Å¡Â Ã¯Â¸Â Fallback  | Si tentap tiene limitaciones, WebView con Tiptap puro como plan B                                       |

**JustificaciÃƒÂ³n de `@10play/tentap-editor`:**

- Usa Tiptap (ProseMirror) dentro de una WebView controlada Ã¢â‚¬â€ rendimiento nativo
...
- Bridge bidireccional RN Ã¢â€ â€ WebView para leer/escribir contenido JSON
- El contenido se almacena como JSON de ProseMirror Ã¢â‚¬â€ serializable, indexable, offline-friendly
- Licencia MIT
...
Ã¢â€â€š DocEditorScreen (RN nativo)     Ã¢â€â€š
...
Ã¢â€â€š Ã¢â€â€š Barra Superior (metadata)   Ã¢â€â€š Ã¢â€â€š  Ã¢â€ Â Campos: asignatura, grado, fecha
Ã¢â€â€š Ã¢â€Å“Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€Â¤ Ã¢â€â€š
Ã¢â€â€š Ã¢â€â€š Toolbar IA (RN nativo)      Ã¢â€â€š Ã¢â€â€š  Ã¢â€ Â Botones: sugerir, autocompletar, mejorar
Ã¢â€â€š Ã¢â€Å“Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€Â¤ Ã¢â€â€š
Ã¢â€â€š Ã¢â€â€š Ã¢â€Å’Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€Â Ã¢â€â€š Ã¢â€â€š
Ã¢â€â€š Ã¢â€â€š Ã¢â€â€š Tentap/Tiptap WebView   Ã¢â€â€š Ã¢â€â€š Ã¢â€â€š  Ã¢â€ Â Canvas de ediciÃƒÂ³n enriquecida
Ã¢â€â€š Ã¢â€â€š Ã¢â€â€š (ProseMirror document)  Ã¢â€â€š Ã¢â€â€š Ã¢â€â€š
Ã¢â€â€š Ã¢â€â€š Ã¢â€â€š Secciones colapsables:  Ã¢â€â€š Ã¢â€â€š Ã¢â€â€š
Ã¢â€â€š Ã¢â€â€š Ã¢â€â€š Ã¢â‚¬Â¢ Info Institucional     Ã¢â€â€š Ã¢â€â€š Ã¢â€â€š
Ã¢â€â€š Ã¢â€â€š Ã¢â€â€š Ã¢â‚¬Â¢ Datos Generales        Ã¢â€â€š Ã¢â€â€š Ã¢â€â€š
Ã¢â€â€š Ã¢â€â€š Ã¢â€â€š Ã¢â‚¬Â¢ Elementos Curriculares Ã¢â€â€š Ã¢â€â€š Ã¢â€â€š
Ã¢â€â€š Ã¢â€â€š Ã¢â€â€š Ã¢â‚¬Â¢ SesiÃƒÂ³n 1..N            Ã¢â€â€š Ã¢â€â€š Ã¢â€â€š
Ã¢â€â€š Ã¢â€â€š Ã¢â€â€š Ã¢â‚¬Â¢ EvaluaciÃƒÂ³n             Ã¢â€â€š Ã¢â€â€š Ã¢â€â€š
Ã¢â€â€š Ã¢â€â€š Ã¢â€â€š Ã¢â‚¬Â¢ Observaciones          Ã¢â€â€š Ã¢â€â€š Ã¢â€â€š
Ã¢â€â€š Ã¢â€â€š Ã¢â€â€š Ã¢â‚¬Â¢ Firmas                 Ã¢â€â€š Ã¢â€â€š Ã¢â€â€š
Ã¢â€â€š Ã¢â€â€š Ã¢â€â€Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€Ëœ Ã¢â€â€š Ã¢â€â€š
Ã¢â€â€š Ã¢â€Å“Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€Â¤ Ã¢â€â€š
Ã¢â€â€š Ã¢â€â€š Formato Toolbar (RN nativo) Ã¢â€â€š Ã¢â€â€š  Ã¢â€ Â Bold, listas, tablas, checkboxes
...
### 2. Dualidad EstÃƒÂ¡ndar vs MÃƒÂ³vil

| Modo          | Dispositivo              | Comportamiento                                                                                                            |
| ------------- | ------------------------ | ------------------------------------------------------------------------------------------------------------------------- |
| **EstÃƒÂ¡ndar** | Tablets, teclado externo | Editor completo tipo Docs con todas las secciones visibles. Toolbar horizontal. NavegaciÃƒÂ³n por teclado                   |
| **MÃƒÂ³vil**    | TelÃƒÂ©fonos celulares     | NavegaciÃƒÂ³n por secciones (wizard/stepper). Una secciÃƒÂ³n a la vez. Inputs optimizados para touch. Acciones IA prominentes |

**DetecciÃƒÂ³n:** `useWindowDimensions()` + `Platform.isPad` + ancho > 768px Ã¢â€ â€™ modo estÃƒÂ¡ndar.

### 3. EscÃƒÂ¡ner y GeneraciÃƒÂ³n de Plantillas

**Flujo:**

1. Docente sube PDF/DOCX (via `expo-document-picker`)
2. El servicio de importaciÃƒÂ³n existente extrae texto raw
3. El texto se envÃƒÂ­a a nuevo endpoint `POST /api/planeaciones/escanear-plantilla`
4. La IA analiza la estructura y devuelve un `PlantillaDocumento` (esquema JSON de secciones, campos, tipos)
5. El frontend renderiza la plantilla vacÃƒÂ­a como un documento editable
6. El docente rellena los campos y guarda como planeaciÃƒÂ³n

### 4. IntegraciÃƒÂ³n de IA como Copiloto

| FunciÃƒÂ³n IA                      | Trigger                                          | Endpoint                                                               |
| -------------------------------- | ------------------------------------------------ | ---------------------------------------------------------------------- |
| **Generar planeaciÃƒÂ³n completa** | BotÃƒÂ³n "Generar con IA" en creaciÃƒÂ³n             | `POST /api/planeaciones/generar` (existente, se amplÃƒÂ­a)               |
| **Autocompletar secciÃƒÂ³n**       | Cursor en secciÃƒÂ³n vacÃƒÂ­a + botÃƒÂ³n Ã¢Å“Â¨           | `POST /api/planeaciones/copiloto` (NUEVO)                              |
| **Sugerir actividades**          | Dentro de una sesiÃƒÂ³n, botÃƒÂ³n "Sugerir"          | `POST /api/planeaciones/copiloto` con `accion: "sugerir_actividades"`  |
| **Mejorar texto**                | Seleccionar texto + botÃƒÂ³n "Mejorar"             | `POST /api/planeaciones/mejorar` (existente, se amplÃƒÂ­a)               |
| **Generar evaluaciÃƒÂ³n**          | SecciÃƒÂ³n evaluaciÃƒÂ³n + botÃƒÂ³n "Generar rÃƒÂºbrica" | `POST /api/planeaciones/copiloto` con `accion: "generar_evaluacion"`   |
| **Revisar alineamiento**         | BotÃƒÂ³n "Revisar" en toolbar IA                   | `POST /api/planeaciones/copiloto` con `accion: "revisar_alineamiento"` |
...
> [!CAUTION]
> El modelo actual de `PlaneacionBase` es **incompatible** con la realidad docente. La migraciÃƒÂ³n requiere transformaciÃƒÂ³n de datos existentes.

### `types/planeacion.ts` Ã¢â‚¬â€ RediseÃƒÂ±o Completo

```typescript
// ===== MODELO V2 Ã¢â‚¬â€ Alineado al NEM y planeaciones reales =====
...
// --- EvaluaciÃƒÂ³n Estructurada ---
export type TipoInstrumento =
  | "escala_valoracion" // SÃƒÂ­ / A veces / No
  | "escala_estimativa" // Excelente / Bueno / Regular / Deficiente
  | "rubrica" // Criterios con niveles de desempeÃƒÂ±o
  | "lista_cotejo" // Cumple / No cumple
  | "otro";

export interface NivelEscala {
  etiqueta: string; // "Excelente", "SÃƒÂ­", etc.
...
export interface CriterioEvaluacion {
  id: string;
  descripcion: string;
  mejora?: string; // "Ã‚Â¿QuÃƒÂ© necesito hacer para mejorar?"
}
...
export interface Firma {
  rol: string; // "Coordinadora acadÃƒÂ©mica", "Docente"
  nombre: string;
}
...
// --- Documento PlaneaciÃƒÂ³n V2 ---
export interface PlaneacionDocumento {
  // Identidad
  id: string;
  version: 2;
  userId: string; // Ã¢â€ Â NUEVO: aislamiento por usuario
  ...
  // Campos especÃƒÂ­ficos por nivel (extensibles)
...
export interface PlantillaDocumento {
  ...
  // Estructura: quÃƒÂ© secciones y campos contiene la plantilla
...
// --- MigraciÃƒÂ³n desde V1 ---
export interface PlaneacionV1 extends PlaneacionBase {
  // El tipo actual Ã¢â‚¬â€ se mantiene para referencia de migraciÃƒÂ³n
}
...
## Plan de EjecuciÃƒÂ³n Ã¢â‚¬â€ Fases y Tareas

---

### FASE 0: Limpieza de CÃƒÂ³digo Legacy

> Eliminar tipos muertos, pantallas obsoletas, dependencias duplicadas y cÃƒÂ³digo que contamina el flujo actual.

- [x] **0.1** Eliminar `PlaneacionFormData` de [types/index.ts](file:///c:/Users/jarco/dev/PlanearIA/types/index.ts) (lÃƒÂ­neas ~514-528) Ã¢â‚¬â€ tipo incompatible nunca usado por la app real
- [x] **0.2** Eliminar constante `COLORS` de [types/index.ts](file:///c:/Users/jarco/dev/PlanearIA/types/index.ts) Ã¢â‚¬â€ duplica `lightTheme/darkTheme`. Migrar todos los imports `import { COLORS } from "../../types"` a `useTheme()`
...
- [x] **0.4** Eliminar la ruta `Home` y la pantalla [HomeScreen.tsx](file:///c:/Users/jarco/dev/PlanearIA/src/screens/home/HomeScreen.tsx) Ã¢â‚¬â€ no se usa, `MainTabs` es el landing post-auth
- [x] **0.5** Evaluar la pantalla [PlaneacionesScreen.tsx](file:///c:/Users/jarco/dev/PlanearIA/src/screens/planeaciones/PlaneacionesScreen.tsx) Ã¢â‚¬â€ CONFIRMADO: ContenidoScreen maneja la lista; PlaneacionesScreen se eliminarÃƒÂ¡ en la Fase 7 y 8
...
- [x] **0.7** Eliminar las funciones `apiRequest` duplicadas en `syncService.ts`, `syncEngine.ts` y `notasUtils.ts` Ã¢â‚¬â€ consolidar en un `src/utils/apiClient.ts` ÃƒÂºnico
- [x] **0.8** Limpiar las referencias `[cite_start]...[cite: N]` de los archivos `.md` en `context/planeaciones-reales/` Ã¢â‚¬â€ son artefactos de transcripciÃƒÂ³n, no contenido pedagÃƒÂ³gico
- [x] **0.9** Evaluar `react-native-worklets` 0.5.1 Ã¢â‚¬â€ verificar si es usado; si no, desinstalar
...
- [x] **1.1** Crear archivo [types/planeacionV2.ts](file:///c:/Users/jarco/dev/PlanearIA/types/planeacionV2.ts) con todas las interfaces del nuevo modelo (ver secciÃƒÂ³n "Nuevo Modelo de Datos" arriba)
- [x] **1.2** Crear `types/plantillaDocumento.ts` con tipos `PlantillaDocumento`, `SeccionPlantilla`, `CampoPlantilla`
- [x] **1.3** Crear funciÃƒÂ³n de migraciÃƒÂ³n `src/utils/migrateV1toV2.ts` que transforme `Planeacion` (V1) Ã¢â€ â€™ `PlaneacionDocumento` (V2):
  - Mapear `actividades[]` Ã¢â€ â€™ una sola `Sesion` con inicio/desarrollo/cierre
  - Mapear `asignatura`, `grado`, `grupo` Ã¢â€ â€™ `DatosGenerales`
  - Mapear `evaluacion` (string) Ã¢â€ â€™ `InstrumentoEvaluacion` con tipo "otro"
  - Mapear `observaciones` (string) Ã¢â€ â€™ `Observacion[]`
  - Agregar `version: 2`, `userId` desde AuthContext
  - Preservar `fechaCreacion` y `fechaModificacion`
- [x] **1.4** Crear tests unitarios para `migrateV1toV2.ts` Ã¢â‚¬â€ cubrir los 4 niveles acadÃƒÂ©micos
- [x] **1.5** Actualizar colecciÃƒÂ³n MongoDB: agregar campo `version` e ÃƒÂ­ndice `{ userId: 1, fechaModificacion: -1 }`
...
### FASE 2: Capa de Datos y SincronizaciÃƒÂ³n

> Migrar planeaciones del `syncService` legacy al `syncEngine` genÃƒÂ©rico. Unificar la estrategia de sync.

- [x] **2.1** Crear `PlaneacionesContext.tsx` en `src/context/` que reemplace el uso de `SyncProvider` para planeaciones:
  - Usar `syncEngine` (genÃƒÂ©rico) en lugar de `syncService` (legacy)
  - Exponer CRUD: `crear`, `actualizar`, `eliminar`, `clonar`, `buscar`
  - Soporte para `PlaneacionDocumento` (V2)
  - Mantener compatibilidad temporal con V1 via migraciÃƒÂ³n on-read
- [x] **2.2** Actualizar el `SyncProvider` actual Ã¢â‚¬â€ remover la lÃƒÂ³gica de planeaciones (queda como wrapper de sync puro o se elimina si ya no tiene propÃƒÂ³sito)
- [x] **2.3** Agregar lÃƒÂ³gica de migraciÃƒÂ³n automÃƒÂ¡tica en `PlaneacionesContext`: al cargar desde AsyncStorage, detectar `version !== 2` y migrar
- [x] **2.4** Actualizar las claves de AsyncStorage:
  - `@planearia:planeaciones` Ã¢â€ â€™ `@planearia:planeaciones_v2` (nueva clave para V2)
  - Mantener la clave vieja como lectura para migraciÃƒÂ³n
...
### FASE 3: InstalaciÃƒÂ³n de Dependencias y Editor Base

> Instalar `@10play/tentap-editor`, configurar el bridge RN Ã¢â€ â€ WebView, crear las extensiones necesarias.
...
- [x] **3.2** Si `tentap-editor` requiere prebuild (mÃƒÂ³dulo nativo), evaluar si migrar de Expo Go a Dev Client. Documentar impacto
  - Resultado: Expo Go soporta uso bÃƒÂ¡sico; para capacidades avanzadas del editor (configuraciÃƒÂ³n extendida y flujo completo de planeaciones) se trabajarÃƒÂ¡ con Dev Client (`npm run start:dev`).
- [x] **3.3** Crear componente base `src/components/editor/RichTextEditor.tsx`:
  - Wrapper de `TenTapEditor` con configuraciÃƒÂ³n base
  - Extensions: `StarterKit`, `Table`, `TaskList`, `Placeholder`, `Heading`
  - Props: `initialContent` (JSON), `onChange`, `editable`, `mode` (estÃƒÂ¡ndar/mÃƒÂ³vil)
...
- [x] **3.4** Crear componente `src/components/editor/EditorToolbar.tsx`:
  ...
  - Estado reactivo: botones activos segÃƒÂºn la selecciÃƒÂ³n actual
  - Layout responsive: horizontal en tablet, compacto en mÃƒÂ³vil
- [x] **3.5** Crear componente `src/components/editor/AIToolbar.tsx`:
  - Barra de acciones IA: Ã¢Å“Â¨ Sugerir, Ã°Å¸â€â€ž Mejorar, Ã°Å¸â€œâ€¹ Generar rÃƒÂºbrica, Ã¢Å“â€¦ Revisar
  - Estado: loading, resultado inline, error
  - IntegraciÃƒÂ³n con endpoints del copiloto
- [x] **3.6** Crear hook `src/hooks/useEditorMode.ts`:
  - Detectar modo estÃƒÂ¡ndar vs mÃƒÂ³vil
  - `useWindowDimensions()` + `Platform.isPad`
  - Threshold: ancho Ã¢â€°Â¥ 768px Ã¢â€ â€™ estÃƒÂ¡ndar
  - Exponer: `mode: "standard" | "mobile"`, `isTablet`, `breakpoint`
- [x] **3.7** Crear componente `src/components/editor/SectionNavigator.tsx`:
  - Solo visible en modo mÃƒÂ³vil
  - Stepper/wizard con ÃƒÂ­conos para cada secciÃƒÂ³n
  - Permite saltar entre secciones sin scroll largo
  - Indicador de progreso (secciones completadas)

---

### FASE 4: Pantallas del Editor Ã¢â‚¬â€ RediseÃƒÂ±o Completo

> Reemplazar el `EditorPlaneacionScreen.tsx` monolÃƒÂ­tico (51KB) por un editor de documento modular.

#### 4A: Componentes de SecciÃƒÂ³n

- [x] **4A.1** Crear `src/components/editor/sections/SeccionInfoInstitucional.tsx`:
  - Campos: instituciÃƒÂ³n, subsistema, ciclo escolar, lugar
  - Modo estÃƒÂ¡ndar: inline editable
  - Modo mÃƒÂ³vil: formulario compacto
...
- [x] **4A.3** Crear `src/components/editor/sections/SeccionCurricular.tsx`:
  - Campos: propÃƒÂ³sito (rich text), producto, contenido, PDA (rich text), campo formativo (select), eje articulador (select)
  - Sub-secciÃƒÂ³n: rasgos de perfil de egreso (multi-select de lista NEM estÃƒÂ¡ndar)
  - BotÃƒÂ³n IA: "Sugerir PDA" basado en asignatura + grado + contenido
- [x] **4A.4** Crear `src/components/editor/sections/SeccionSesiones.tsx`:
  - Lista de sesiones con add/remove/reorder
  - Cada sesiÃƒÂ³n: componente `SesionCard` colapsable
  - Dentro de SesionCard: 4 campos rich text (inicio, desarrollo, cierre, tarea)
  - Selector de tipo de sesiÃƒÂ³n (regular, suspensiÃƒÂ³n, proyecto, evaluaciÃƒÂ³n)
  - Para suspensiÃƒÂ³n: solo campo "motivo"
  - BotÃƒÂ³n IA por sesiÃƒÂ³n: "Sugerir actividades para esta sesiÃƒÂ³n"
- [x] **4A.5** Crear `src/components/editor/sections/SesionCard.tsx`:
  - Componente individual de sesiÃƒÂ³n
  - Header con nÃƒÂºmero + tipo + ÃƒÂ­cono
  - 3-4 editores rich text mini (inicio/desarrollo/cierre/tarea)
  - Soporte para actividades embebidas (checkboxes, listas numeradas)
  - Colapsable (expandido por defecto solo la sesiÃƒÂ³n activa)
- [x] **4A.6** Refactorizar [EvaluacionEditor.tsx](file:///c:/Users/jarco/dev/PlanearIA/src/components/EvaluacionEditor.tsx) (20KB) Ã¢â€ â€™ `src/components/editor/sections/SeccionEvaluacion.tsx`:
  - Selector de tipo de instrumento (escala valoraciÃƒÂ³n, escala estimativa, rÃƒÂºbrica, lista cotejo)
  - Constructor dinÃƒÂ¡mico de escala (agregar/quitar niveles)
  - Constructor de criterios (agregar/quitar/editar)
  - Vista previa de la tabla de evaluaciÃƒÂ³n
  - Soporte para evaluaciÃƒÂ³n inicial (opcional) y final
- [x] **4A.7** Crear `src/components/editor/sections/SeccionObservaciones.tsx`:
  - Lista de observaciones con categorÃƒÂ­a (select) + texto
  - BotÃƒÂ³n agregar observaciÃƒÂ³n
...
- [x] **4B.1** Crear nueva pantalla `src/screens/planeaciones/DocEditorScreen.tsx`:
  ...
  - Modo estÃƒÂ¡ndar: scroll continuo con todas las secciones
  - Modo mÃƒÂ³vil: navegaciÃƒÂ³n por secciones (SectionNavigator)
  - Barra superior con metadata resumida + botÃƒÂ³n guardar
...
- [x] **4B.2** Crear nuevo ViewModel `src/hooks/useDocEditorViewModel.ts`:
  ...
  - ValidaciÃƒÂ³n por secciÃƒÂ³n
  - LÃƒÂ³gica de guardado (draft vs commit)
  - IntegraciÃƒÂ³n con `PlaneacionesContext` para persistir
  - Historial de cambios (undo bÃƒÂ¡sico via stack de estados)
- [x] **4B.3** RediseÃƒÂ±ar `src/screens/planeaciones/CrearPlaneacionScreen.tsx`:
  - Wizard de 3 pasos: (1) Nivel (2) MÃƒÂ©todo (desde cero / IA / importar / plantilla) (3) ConfiguraciÃƒÂ³n inicial
  - Paso 2 agrega la opciÃƒÂ³n "Desde plantilla" usando el nuevo sistema de plantillas
  - Al finalizar Ã¢â€ â€™ navega a `DocEditor` con datos iniciales
- [x] **4B.4** RediseÃƒÂ±ar `src/screens/planeaciones/ListaPlaneacionesScreen.tsx`:
  - Cards con vista previa del documento (asignatura + grado + semanas + ÃƒÂºltimo edit)
  - BÃƒÂºsqueda full-text
  - Filtros por nivel, asignatura, fecha
  - Acciones: editar, clonar, exportar, eliminar
  - Indicador de sync status por planeaciÃƒÂ³n
- [x] **4B.5** Actualizar ViewModel `src/hooks/useListaPlaneacionesViewModel.ts`:
  - Adaptar al nuevo tipo `PlaneacionDocumento`
  - Agregar bÃƒÂºsqueda full-text
  - Integrar con `PlaneacionesContext` (en lugar de `useSyncPlaneaciones`)

---

### FASE 5: EscÃƒÂ¡ner de Plantillas
...
- [x] **5.1** Crear endpoint `backend/api/planeaciones/escanear-plantilla.js`:
  ...
  - System prompt: "Analiza este documento de planeaciÃƒÂ³n didÃƒÂ¡ctica y extrae su estructura..."
  - Responde: `{ plantilla: PlantillaDocumento }` Ã¢â‚¬â€ esquema JSON de secciones y campos
  - Incluir inferencia de nivel acadÃƒÂ©mico si no se proporciona
- [x] **5.2** Refactorizar [planeacionImportService.ts](file:///c:/Users/jarco/dev/PlanearIA/src/services/planeacionImportService.ts):
  - Mantener la extracciÃƒÂ³n de texto de PDF/DOCX (`extractTextFromPdf`, `extractTextFromDocx`)
  - Nuevo modo: `parseMode: "planeacion" | "plantilla"`
  - Modo "plantilla": envÃƒÂ­a texto al endpoint de escaneo IA
  - Modo "planeaciÃƒÂ³n": extrae campos y crea `PlaneacionDocumento` V2 (ya no hardcodea secundaria)
...
- [x] **5.3** Crear pantalla `src/screens/planeaciones/EscanerPlantillaScreen.tsx`:
  ...
  - Paso 2: Vista previa del texto extraÃƒÂ­do
  - Paso 3: Loading de anÃƒÂ¡lisis IA
  - Paso 4: Vista previa de la plantilla detectada (secciones + campos)
  - Paso 5: Editar/confirmar plantilla Ã¢â€ â€™ guardar en `PlantillasContext`
...
- [x] **5.5** Integrar las plantillas escaneadas con el flujo de creaciÃƒÂ³n: en `CrearPlaneacionScreen` paso "Desde plantilla" Ã¢â€ â€™ listar plantillas del usuario + comunidad Ã¢â€ â€™ seleccionar Ã¢â€ â€™ crear documento pre-poblado

---

### FASE 6: IntegraciÃƒÂ³n IA Copiloto
...
- [x] **6.1** Crear endpoint `backend/api/planeaciones/copiloto.js`:
  ...
  - Acciones soportadas:
    - `sugerir_actividades` Ã¢â‚¬â€ genera inicio/desarrollo/cierre para una sesiÃƒÂ³n
    - `autocompletar_seccion` Ã¢â‚¬â€ completa una secciÃƒÂ³n basada en el contexto del documento
    - `generar_evaluacion` Ã¢â‚¬â€ crea instrumento de evaluaciÃƒÂ³n con criterios
    - `revisar_alineamiento` Ã¢â‚¬â€ verifica coherencia entre PDA, actividades y evaluaciÃƒÂ³n
    - `mejorar_texto` Ã¢â‚¬â€ reescribe texto seleccionado con mejor redacciÃƒÂ³n
  - System prompt contextual: incluir nivel, asignatura, grado, NEM
  - Response format: JSON estructurado segÃƒÂºn la acciÃƒÂ³n
- [x] **6.2** Crear servicio `src/services/copilotoService.ts`:
  - AbstracciÃƒÂ³n del endpoint copiloto
  - MÃƒÂ©todos tipados: `sugerirActividades()`, `autocompletarSeccion()`, `generarEvaluacion()`, `revisarAlineamiento()`, `mejorarTexto()`
...
- [x] **6.3** Crear hook `src/hooks/useCopiloto.ts`:
  ...
  - MÃƒÂ©todos que llaman al servicio
  - CachÃƒÂ© local de sugerencias recientes
  - IntegraciÃƒÂ³n con el editor: insertar resultado en la posiciÃƒÂ³n del cursor
- [x] **6.4** Integrar copiloto en `AIToolbar.tsx`:
  - Botones contextuales (cambian segÃƒÂºn la secciÃƒÂ³n activa del editor)
  - Panel de sugerencias deslizable desde abajo
  - AnimaciÃƒÂ³n de "pensando..." durante generaciÃƒÂ³n
...
- [x] **6.5** Actualizar endpoint existente [generar.js](file:///c:/Users/jarco/dev/PlanearIA/backend/api/planeaciones/generar.js):
  - Actualizar el schema del system prompt para generar `PlaneacionDocumento` V2 (multi-sesiÃƒÂ³n, evaluaciÃƒÂ³n estructurada)
  - Agregar soporte para mÃƒÂ¡s niveles de detalle en el prompt
  - Mantener retrocompatibilidad: si `version` no se envÃƒÂ­a, generar V1

---

### FASE 7: ExportaciÃƒÂ³n y NavegaciÃƒÂ³n

> Actualizar la exportaciÃƒÂ³n para renderizar documentos V2 y limpiar la navegaciÃƒÂ³n.

- [x] **7.1** Refactorizar [planeacionExportService.ts](file:///c:/Users/jarco/dev/PlanearIA/src/services/planeacionExportService.ts):
  - `buildPlaneacionPdfHtml()` Ã¢â€ â€™ recibe `PlaneacionDocumento` V2
  - Renderizar todas las secciones: info institucional, datos generales, curricular, N sesiones, evaluaciÃƒÂ³n (tabla), observaciones, firmas
  - Template HTML profesional con estilos del PDF original (tablas, bordes, checkboxes)
  - Mantener exportaciÃƒÂ³n DOCX actualizada con la misma estructura
- [x] **7.2** Actualizar pantalla [ExportarPlaneacionScreen.tsx](file:///c:/Users/jarco/dev/PlanearIA/src/screens/planeaciones/ExportarPlaneacionScreen.tsx):
  ...
  - Opciones granulares: quÃƒÂ© secciones incluir
  - Formatos: PDF, DOCX
- [x] **7.3** Actualizar navegaciÃƒÂ³n en [StackNavigator.tsx](file:///c:/Users/jarco/dev/PlanearIA/src/navigation/StackNavigator.tsx):
...
- [x] **7.4** Actualizar [ContenidoScreen.tsx](file:///c:/Users/jarco/dev/PlanearIA/src/screens/contenido/ContenidoScreen.tsx):
  - La pestaÃƒÂ±a "Planeaciones" debe usar `PlaneacionesContext` (V2)
  - BotÃƒÂ³n "Crear" Ã¢â€ â€™ navega a `CrearPlaneacion` (wizard rediseÃƒÂ±ado)
  - Cards de planeaciÃƒÂ³n con nuevo formato (multi-semana, asignatura, sync status)
- [x] **7.5** Actualizar [CrearNuevoModal.tsx](file:///c:/Users/jarco/dev/PlanearIA/src/components/CrearNuevoModal.tsx):
  - OpciÃƒÂ³n "PlaneaciÃƒÂ³n" Ã¢â€ â€™ navega a `CrearPlaneacion`
  - Agregar opciÃƒÂ³n "Escanear Plantilla" Ã¢â€ â€™ navega a `EscanerPlantilla`
...
### FASE 8: EliminaciÃƒÂ³n del CÃƒÂ³digo Viejo y VerificaciÃƒÂ³n

> Limpieza final: eliminar pantallas, hooks y componentes que fueron reemplazados.

- [x] **8.1** Eliminar [EditorPlaneacionScreen.tsx](file:///c:/Users/jarco/dev/PlanearIA/src/screens/planeaciones/EditorPlaneacionScreen.tsx) (51KB) Ã¢â‚¬â€ reemplazado por `DocEditorScreen`
- [x] **8.2** Eliminar [useEditorPlaneacionViewModel.ts](file:///c:/Users/jarco/dev/PlanearIA/src/hooks/useEditorPlaneacionViewModel.ts) Ã¢â‚¬â€ reemplazado por `useDocEditorViewModel`
- [x] **8.3** Eliminar [useUniversityDetailMode.ts](file:///c:/Users/jarco/dev/PlanearIA/src/hooks/useUniversityDetailMode.ts) Ã¢â‚¬â€ la dualidad de modos ya no usa este approach
- [x] **8.4** Eliminar [SemanaEditor.tsx](file:///c:/Users/jarco/dev/PlanearIA/src/components/SemanaEditor.tsx) (22KB) Ã¢â‚¬â€ las sesiones ahora se manejan en `SeccionSesiones`
- [x] **8.5** Evaluar eliminaciÃƒÂ³n del viejo [EvaluacionEditor.tsx](file:///c:/Users/jarco/dev/PlanearIA/src/components/EvaluacionEditor.tsx) (20KB) Ã¢â‚¬â€ reemplazado por `SeccionEvaluacion`
- [x] **8.6** Eliminar `syncService.ts` legacy (si ya no es usado por ningÃƒÂºn otro mÃƒÂ³dulo tras Fase 2)
- [x] **8.7** Eliminar el archivo `types/planeacion.ts` original Ã¢â‚¬â€ reemplazado por `planeacionV2.ts`. Actualizar todos los imports
- [x] **8.8** Ejecutar `npx tsc --noEmit` Ã¢â‚¬â€ verificar que no hay errores de TypeScript
- [x] **8.9** Ejecutar `npm test` Ã¢â‚¬â€ verificar que los tests pasan (actualizar los que fallen)
- [x] **8.10** Ejecutar `npm run lint` Ã¢â‚¬â€ verificar que no hay errores de linting
...
- [x] **8.12** Verificar migraciÃƒÂ³n de datos existentes: cargar app con datos V1 en AsyncStorage Ã¢â€ â€™ verificar que migran a V2 sin pÃƒÂ©rdida
...
- [x] **9.1 Auditar y documentar la IA usada en Planeaciones**:
  ...
  - **Avance aplicado 2026-05-28:** documento de auditoria publicado en `Documentacion/01-planes-maestros/PLANEACIONES_IA_EDITOR_FASE9.md` con endpoints, proveedor real, modelo default, variables requeridas y matriz real/fallback por endpoint.
...
- [x] **9.2 Definir criterio de aceptacion del editor tipo Word/Docs**:
  ...
  - **Avance aplicado 2026-05-28:** criterio de aceptacion consolidado y publicado en `Documentacion/01-planes-maestros/PLANEACIONES_IA_EDITOR_FASE9.md` con checklist funcional de cierre.
...
- [x] **9.13 Validacion manual end-to-end final (movida desde 8.11)**:
  ...
  - **Checklist oficial de ejecucion manual:** `Documentacion/03-validacion/CHECKLIST_VALIDACION_MANUAL_FASE9.md`.
...
| `screens/planeaciones/CrearPlaneacionScreen.tsx`    | 4B.3    | Wizard rediseÃƒÂ±ado                                     |
...
| `hooks/useCrearPlaneacionViewModel.ts`              | 4B.3    | Wizard rediseÃƒÂ±ado                                     |
| `components/CrearNuevoModal.tsx`                    | 7.5     | Agregar opciÃƒÂ³n escanear                               |
...
> [!IMPORTANT]
> **Q1 Ã¢â‚¬â€ Expo Go vs Dev Client:** `@10play/tentap-editor` usa cÃƒÂ³digo nativo. Esto **probablemente requiere migrar de Expo Go a Dev Client** (`expo-dev-client`). El paquete ya estÃƒÂ¡ en `package.json` pero confirma: Ã‚Â¿estÃƒÂ¡s usando Expo Go actualmente o ya tienes un dev client configurado? Estoy usando Expo Go, no tengo configurado el expo dev client, si es estrictamente necesario, tendras que instruirme para poder configurarlo.

> [!IMPORTANT]
> **Q2 Ã¢â‚¬â€ Plantillas existentes:** El mÃƒÂ³dulo de Plantillas (`PlantillasContext`, `BibliotecaPlantillasScreen`, etc.) ya existe. Ã‚Â¿Las plantillas actuales deben integrarse con el nuevo sistema de `PlantillaDocumento` del escÃƒÂ¡ner, o se mantienen como un sistema separado? como un sistema separado, las plantillas actuales que mencionas son legacy y tambien en su momento seran reemplazados con otro plan de refactorizacion.

> [!WARNING]
> **Q3 Ã¢â‚¬â€ MigraciÃƒÂ³n de datos en producciÃƒÂ³n:** Si hay docentes con planeaciones V1 guardadas en producciÃƒÂ³n, la migraciÃƒÂ³n V1Ã¢â€ â€™V2 se ejecutarÃƒÂ¡ automÃƒÂ¡ticamente en el cliente. Ã‚Â¿Existe data de producciÃƒÂ³n que debamos considerar, o el MVP solo tiene datos de testing? No consideres nada, todos los datos son de testing y la app aun no es desplegada totalmente o aun no se lanza ni estan produccion.

> [!NOTE]
> **Q4 Ã¢â‚¬â€ Modelo "Universidad":** El modelo actual tiene un modo detallado para universidad con `SemanaUniversitaria`, `ConfiguracionCurso`, etc. El archivo de Mate Discretas sÃƒÂ­ estÃƒÂ¡ transcrito en [Matediscretas.md](file:///c:/Users/jarco/dev/PlanearIA/context/planeaciones-reales/MATEDISCRETA/Matediscretas.md). Adaptaremos la estructura universitaria para que encaje de manera limpia y armoniosa dentro de este nuevo modelo modular (Fase 1).

---

## Orden de EjecuciÃƒÂ³n Recomendado

```mermaid
gantt
    title Fases de EjecuciÃƒÂ³n
    dateFormat  X
    axisFormat %s

    section PreparaciÃƒÂ³n
    ...
    Fase 5 - EscÃƒÂ¡ner Plantillas         :f5, 15, 3
...
**Dependencias crÃƒÂ­ticas:**

- Fase 1 Ã¢â€ â€™ Fase 2 (tipos necesarios para contexto)
- Fase 3 Ã¢â€ â€™ Fase 4 (editor base necesario para pantallas)
- Fases 4, 5, 6 pueden avanzar en paralelo una vez completadas las bases
- Fase 8 es siempre la ÃƒÂºltima
