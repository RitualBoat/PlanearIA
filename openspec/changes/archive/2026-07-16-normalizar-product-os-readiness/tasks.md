...
- [x] 2.3 Actualizar `readiness.json` con referencias reales de validacion, issue, PR, evidencia documental y rollback a medida que esten disponibles; no registrar comandos arbitrarios ni evidencia pendiente como final.
...
- [x] 4.4 Vincular el PR y la evidencia documental reales en `readiness.json`; el archive ejecutara su gate DoD y no movera el change mientras exista algun `FAIL`.
