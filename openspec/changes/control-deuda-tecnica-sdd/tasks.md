...
- [x] 1.4 `registry.mjs`: carga/guardado atomico, ciclo de vida de items (open/resolved/refuted/duplicate/accepted-exception), merge de occurrences, validacion de excepciones.
