# agent knowledge graph policy Specification

## Purpose
Define how PlanearIA evaluates and routes AI-agent code-intelligence tools so SDD work uses evidence-backed context instead of stale or duplicated tool calls.
