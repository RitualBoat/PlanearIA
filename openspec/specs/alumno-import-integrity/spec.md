# alumno-import-integrity Specification

## Purpose
Guarantee that multi-row alumno import persists every valid selected row exactly once, offline-first and sync-compatible, without stale-state overwrites.
