# cross-context-change-contract Specification

## Purpose

Definir el contrato de planificación que distingue los changes intra-contexto de las integraciones que cruzan límites de dominio en PlanearIA.
