# frontend-public-env-boundary Specification

## Purpose
Ensure PlanearIA frontend configuration never treats public Expo environment variables as secrets or privileged credentials, and that authenticated user operations rely on JWT.
