# react-doctor-scan-baseline Specification

## Purpose
Define how React Doctor scans distinguish PlanearIA product source from generated, local, and reference-only folders, and keep CI advisory until the product baseline is trustworthy.
