# strategic-domain-map Specification

## Purpose

Definir el mapa DDD estratégico ligero que guía el lenguaje, la propiedad de datos y los límites de contexto de PlanearIA sin alterar su monolito modular.
