    ...
    <View style={styles.container}>
      ...
      <SafeAreaView style={styles.safeArea}>
        <ScrollView contentContainerStyle={styles.scrollContent}>
          ...
          <Text style={styles.subtitle}>Visualiza ideas y conceptos</Text>
          ...
          <View style={styles.optionsContainer}>
            <TouchableOpacity style={styles.optionCard} activeOpacity={0.7}>
              ...
              <Text style={styles.optionDescription}>
                La IA organizará tus conceptos automáticamente
              </Text>
            </TouchableOpacity>
            ...
            <TouchableOpacity style={styles.optionCard} activeOpacity={0.7}>
              ...
              <Text style={styles.optionDescription}>
                Estructuras prediseñadas para diferentes temas
              </Text>
            </TouchableOpacity>
...
export default MapasMentalesScreen;
