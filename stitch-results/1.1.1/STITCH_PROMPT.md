...
Diseña un módulo completo de **perfil de usuario para docentes** en una app educativa. Necesito **múltiples pantallas/vistas** que cubran todos los flujos posibles. El diseño debe verse en **2 breakpoints**: teléfono (390px) y desktop/web (1280px).

---

> ✂️ ═══════════════════════════════════════════════════════════════
>
> ## PARTE 1 DE 5 — Perfil Principal + Editar Perfil
>
> **Copia desde aquí hasta el próximo ✂️**
> ═══════════════════════════════════════════════════════════════ ✂️

Módulo de **perfil de usuario para docentes** en **PlanearIA** (app educativa). Breakpoints: 390px (móvil), 1280px (desktop/web).
...
8. **Botón Guardar:** Ancho completo en mobile, alineado a la derecha en desktop/web. Azul primario, bold, border-radius 12px. Estados: normal → loading (spinner) → éxito
...
- Modales: border-radius 20px en mobile (top), 16px all sides en desktop/web
- Bottom sheets: border-radius 20px top

### Espaciado

- Padding lateral: 16px mobile, auto-centrado desktop
- Padding interno cards: 16px
- Gap entre secciones: 20px
- Gap entre items de actividad: 12px
- Portada altura: 160px mobile, 220px desktop
...
> ✂️ ═══════════════════════════════════════════════════════════════
>
> ## PARTE 3 DE 5 — Feedback: Perfil, Errores y Foto (4A–4D)
>
> **Copia desde aquí hasta el próximo ✂️**
> ═══════════════════════════════════════════════════════════════ ✂️
...
> ✂️ ═══════════════════════════════════════════════════════════════
>
> ## PARTE 4 DE 5 — Feedback: Cambios, Compartir e Imagen (4E–4G)
>
> **Copia desde aquí hasta el próximo ✂️**
> ═══════════════════════════════════════════════════════════════ ✂️
...
## PANTALLA 4 (continuación): Feedback — Cambios, Compartir e Imagen
...
> ✂️ ═══════════════════════════════════════════════════════════════
>
> ## PARTE 5 DE 5 — Menú Contextual + Stats Expandida
>
...
**Desktop/Web:** Dropdown menu posicionado debajo del avatar con las mismas opciones
...
**Desktop/Web:** Popover/tooltip expandido junto a la métrica
