...
La rama por defecto exige PR, checks de CI y conversaciones resueltas; prohíbe force-push y borrado. El
environment `npm-publish` protege la identidad OIDC. Un plan remoto se previsualiza con
